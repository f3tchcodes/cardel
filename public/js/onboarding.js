document.addEventListener('DOMContentLoaded', () => {
    ...
    function addTag(dropdown, name, img) {
        ...
        if ([...container.children].some(t => t.dataset.name === name)) return;
    ...
    function submitOnboarding() {
        document.getElementById('hidden_subUse').value = Array.from(selectedSubs).join(',');
        document.getElementById('hidden_subManage').value = document.getElementById('subManage').value;
        document.getElementById('hidden_hearAbout').value = document.getElementById('hearAbout').value;
        document.getElementById('hidden_notifyDays').value = document.getElementById('notifyDays').value;
        document.getElementById('hidden_subNumber').value = document.getElementById('subNumber').value;
        document.getElementById('hidden_subMonthlySpend').value = document.getElementById('subMonthlySpend').value;
